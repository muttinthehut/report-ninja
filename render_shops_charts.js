...
RenderUrlsToFile = function(urls, callbackPerUrl, callbackFinal) {
    ...
    getFilename = function() {
        return "client_shops_" + urlIndex + ".png";
    };
...
if (phantom.args.length != 1) {
    console.log('Usage: render_shops_charts.js # , where # is the number of clients');
    phantom.exit();
} else {
	...
	for (var i=0; i<maxurls; i++) {
		arrayOfUrls.push("https://report-ninja-c9-muttinthehut.c9.io/client_crossshops/get/"+(i+1)+"/");
	}
