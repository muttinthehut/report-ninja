import os;
# Django settings for report_ninja project.

DEBUG = True
TEMPLATE_DEBUG = DEBUG

ADMINS = (
    # ('Joe Burns', 'jburns@dataium.com'),
)
...
SECRET_KEY = 'n)l7)b=y)34o(a6hrv7vaeq=138j_d8w$qrsu(!i!ax82dvp%9'
...
WSGI_APPLICATION = 'report_ninja.wsgi.application'
